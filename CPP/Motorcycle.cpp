...
public:
    //constructor default untuk motor dibawahnya constructor overload karena tidak memungkinkan untuk null pada data jadi di defaultkan dan ditambah parameter dari superclass
